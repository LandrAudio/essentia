...
namespace streaming {
    ...
    AlgorithmStatus LandrMFCC::process() {
    ...
    void LandrMFCC::GenerateMFCCFilters(int fftSize, double sampleRate) {
    ...
    void LandrMFCC::GenerateDCTMatrix(int numBands, int numCoeffs) {
